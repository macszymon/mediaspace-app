...
namespace Server.Repository
{
    public class TitleRepository : ITitleRepository
    {
        ...
        {
            var titles = _context.Titles.Include(t => t.TitleCategories).ThenInclude(t => t.Category).Include(t => t.Reviews).ThenInclude(r => r.AppUser).Include(r => r.Type).AsQueryable();
        ...
        {
            return await _context.Titles.Include(t => t.TitleCategories).ThenInclude(t => t.Category).Include(t => t.Reviews).ThenInclude(r => r.AppUser).Include(r => r.Type).FirstOrDefaultAsync(i => i.Id == id);
        }
        ...
        public async Task<Title?> UpdateAsync(int id, UpdateTitleDto titleDto)
        {
            ...
            title.Platforms = titleDto.Platforms;
